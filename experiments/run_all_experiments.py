...
dataset_hartmann6 = ['hartmann3', 'hartmann6']
...
# methods = ['qEI', 'EI-LP', 'EI-KB', 'EI-CL', 'CBBO-EI', 'qUCB', 'BUCB', 'UCB-PE', 'UCB-LP', 'CBBO-UCB']
